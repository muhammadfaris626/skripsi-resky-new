    ...
    <div class="grid grid-cols-1 gap-4">
        <div>
            <div class="flex justify-between items-center">
                <div>
                    <flux:heading size="xl">Update Permission</flux:heading>
                    <flux:text class="mt-2">Edit permission information</flux:text>
                </div>
            </div>
        </div>
        <div>
                ...
                <form wire:submit.prevent="update" class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-start gap-2">
                            ...
                            <div><flux:button variant="primary" type="submit">Update Permission</flux:button></div>
                        </div>
                    </div>
                </form>
            </div>
