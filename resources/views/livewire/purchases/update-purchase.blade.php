    ...
    <div class="grid grid-cols-1 gap-4">
        <div>
            <div class="flex justify-between items-center">
                <div>
                    <flux:heading size="xl">Edit Purchase</flux:heading>
                    <flux:text class="mt-2">Update purchase information</flux:text>
                </div>
            </div>
        </div>
        <div>
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-start gap-2">
                            ...
                            <div><flux:button variant="primary" type="submit" :disabled="count($items) === 0">Update Purchase</flux:button></div>
                        </div>
                    </div>
                </form>
            </div>
