    ...
    <div class="grid grid-cols-1 gap-4">
        <div>
            <div class="flex justify-between items-center">
                <div>
                    <flux:heading size="xl">Update Employee</flux:heading>
                    <flux:text class="mt-2">Update employee information in database</flux:text>
                </div>
            </div>
        </div>
        <div>
                    ...
                    <form wire:submit.prevent="update" class="space-y-4">
                        ...
                        <div>
                            <div class="flex justify-start gap-2">
                                ...
                                <div><flux:button type="submit" variant="primary">Update</flux:button></div>
                            </div>
                        </div>
                    </form>
                </div>
