    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                ...
                'data-current:bg-(--color-accent-content) dark:data-current:bg-white/[7%] data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
